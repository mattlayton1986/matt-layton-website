const resume = {
  profile:
    "Dedicated and collaborative Front End Developer with 3+ years of professional experience at varying degrees of complexity and responsibility, including a corporate rebrand and phased onboarding for an enterprise client. Successfully trained and mentored six newly hired developers over two years. Motivated and eager to learn new technology and improve on existing skills.",
  experience: [
    {
    ...
    {
      dates: "August 2018 to December 2019",
      ...
      courses: [
        {
          ...
          instructor: "Andrei Neagoie and Yihua Zhang",
          status: "Udemy course completed",
        },
        {
          name: "Complete Python Developer in 2021",
          instructor: "Andrei Neagoie",
          status: "Udemy course in progress",
        },
        {
          name: "JavaScript Web Projects: 20 Projects To Build Your Portfolio",
          instructor: "Andrei Neagoie and Jacinto Wong",
          status: "Udemy course in progress",
        },
      ],
    },
      ...
      courses: [
        {
          ...
          instructor: null,
          status: "98 credits earned toward degree",
        },
      ],
    },
  ],
  skills: [
    {
      category: "Experienced Technologies",
      skills: [
        "JavaScript (ES6, jQuery; NodeJS)",
        "CSS (Sass, Bootstrap, Tailwind)",
        "HTML",
        "React (Router, Redux, Sagas, Hooks)",
        "Version Control (Git)",
    ...
    },
    {
      ...
      skills: ["Python 3", "TypeScript", "Angular"],
    },
  ],
};
